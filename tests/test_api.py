...
class APITestCase(unittest.TestCase):
    ...
    def test_posts(self):
        ...
        # write an empty post (should fail)
        response = self.client.post(
            '/api/v1/posts/',
            headers=self.get_api_headers('john@example.com', 'cat'),
        ...
        # get the Location header (canonical URL of the new post)
